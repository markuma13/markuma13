...
## Обо мне:
Я позитивный и общительный парень, который идет по пути развития в качестве QA Engineer. Мой путь начался 2022 году по изучению информации в сфере тестирования. На данный момент я углубляю свои знания в теории и практики по автоматизации тестирования на языке Java. Обладаю практическим опытом в разработке тестов с использованием современных инструментов: Appium, Selenium, Selenide, Rest Assured. Понимание методологии Page Object и опыт тестовых сценариев с системами непрерывной интеграции Jenkins. Опыт в работе с Allure для создания информативных отчетов о тестировании.
